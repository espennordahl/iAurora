...
int SquareLight::m_halton_index = 0;
...
std::shared_ptr<Shape> SquareLight::shape(){
	Point p1 = Point(-xScale, -yScale, 0);
	Point p2 = Point(-xScale,yScale, 0);
	Point p3 = Point(xScale, yScale, 0);
	Point p4 = Point(xScale, -yScale, 0);
    ...
    std::shared_ptr<Shape> s = std::shared_ptr<Shape>(new TriangleMesh(objectToCamera, cameraToObject, 2, 4, Index, P, N, NULL));
