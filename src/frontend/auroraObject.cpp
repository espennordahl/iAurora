...
AuroraObject::AuroraObject(std::string name, RenderEnvironment *renderEnv, std::shared_ptr<Shape> shape, Material * material ) :
FrontEndObject(name, renderEnv), 
m_shape(shape), m_material(material) {
	
}

AuroraObject::AuroraObject(std::string name, RenderEnvironment *renderEnv, std::shared_ptr<Shape> shape, std::string matName ):
FrontEndObject(name, renderEnv),
